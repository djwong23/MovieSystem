...
def get_popular_movies(d, n=10):
    ...
    return {movies[i][0]: movies[i][1] for i in range(0, min(len(d.keys()), n))}
...
def genre_popularity(genre_to_movies, movie_to_average_rating, n=5):
    ...
    genreRatings = {genres[i]: get_genre_rating(genres[i], genre_to_movies, movie_to_average_rating) for i in
                    range(0, min(len(genres), n))}
...
def main():
    ...
    # print(get_popular_movies(calculate_average_rating(read_ratings_data('movieRatingSample.txt')), 999))
    # print(filter_movies(calculate_average_rating(read_ratings_data('movieRatingSample.txt')), 3))

    # my tests
    # print(get_genre_rating('Adventure', create_genre_dict(read_movie_genre('genreMovieSample.txt')),
    #                        calculate_average_rating(read_ratings_data('movieRatingSample.txt'))))
    # print(genre_popularity(create_genre_dict(read_movie_genre('genreMovieSample.txt')), calculate_average_rating(read_ratings_data('movieRatingSample.txt')), 3))
    print(read_user_ratings('movieRatingSample.txt'))
    print(get_user_genre(1, read_user_ratings('movieRatingSample.txt'), read_movie_genre('genreMovieSample.txt')))
